 ...
 function Spellcaster(name, health, mana){
   ...
   */
   ...
   // Spellcaster.prototype.invoke = function(spell, target){
    // if (spell instanceof DamageSpell){ //check spell pram to be instance of DamageSpell
     // if (target instanceof Spellcaster){ // check target pram to be instance of Spellcaster
      // if (this.spendMana(spell.cost)){ //invoke spendMana if true (has mana)
        // target.inflictDamage(spell.damage); //invoke inflictDamage
        // return true;
        // }
        // return false;
      // }
